...
[`context/user.nix`](https://github.com/denful/den/blob/main/modules/context/user.nix) ·
[`context/host.nix`](https://github.com/denful/den/blob/main/modules/context/host.nix) ·
[`mutual-provider.nix`](https://github.com/denful/den/blob/main/modules/aspects/provides/mutual-provider.nix)
</Aside>
...
To do so, Den invokes the `den.stages.host` pipeline like this:
...
sequenceDiagram
   participant Den
   participant host as den.stages.host
   participant user as den.stages.user
...
This is the normal `den.stages.host` pipeline. All OS contributions come from the host itself and from each of its user.


## `den.provides.mutual-provider`

The [`den.provides.mutual-provider`](https://github.com/denful/den/blob/main/modules/aspects/provides/mutual-provider.nix) battery allows you to define mutual configurations by letting you to define named aspects under `.provides.` to create explicit policy between users and hosts.
