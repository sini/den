...
- [flake-file](https://github.com/vic/flake-file) — real Nix input definitions and output schemas
- [import-tree](https://github.com/vic/import-tree) — recursive module imports
- [with-inputs](https://github.com/vic/with-inputs) — flake resolved inputs for non-flakes
