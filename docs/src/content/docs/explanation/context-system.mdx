...
This page describes `den.ctx`, which is deprecated. The concepts have been split into three dedicated pages:
- [Entities & Schema](/explanation/entities/) — typed data declarations
- [Stages](/explanation/stages/) — scoped behavior bindings
- [Policies](/explanation/policies/) — entity relationships and topology

`den.ctx` still works via a compatibility shim with deprecation warnings.
See [Migrating from den.ctx](/guides/migrate-ctx/) for upgrade steps.
</Aside>

<Aside title="Source" icon="github">
[`modules/context/types.nix`](https://github.com/denful/den/blob/main/modules/context/types.nix) --
[`modules/context/os.nix`](https://github.com/denful/den/blob/main/modules/context/os.nix)
</Aside>
