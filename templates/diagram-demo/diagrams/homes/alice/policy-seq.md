...
sequenceDiagram
    participant root as alice
    participant home_to_default as home-to-default

    root ->> home_to_default: dispatch
    activate home_to_default
    Note over home_to_default: default/resolve(alice), default/resolve(default), provides/default/resolve(define-user):den/provides, provides/default/resolve(hostname):den/provides<br/>provides/default/resolve(mutual-provider):den/provides, provides/define-user, provides/hostname, provides/mutual-provider
    deactivate home_to_default
```
