# Stage Sequence (expanded): home-alice
...
sequenceDiagram
    ...
    deactivate home
    Note over home: default, demo-shell, dev-tools, home-bat<br/>home-firefox, home-git, home-slack, hyprland<br/>policy:home-to-default, provides/primary-user
