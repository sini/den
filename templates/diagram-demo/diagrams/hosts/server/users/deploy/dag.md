...
graph LR
  ...
  default__resolve_deploy_server_{{"default/resolve(deploy,server)"}}:::default__resolve_deploy_server__c
  ...
  den__provides__mutual_provider --> default__resolve_deploy_server_
  ...
  n_default --> default__resolve_deploy_server_
  ...
  classDef default__resolve_deploy_server__c fill:#313244,stroke:#6c7086,color:#cdd6f4,stroke-dasharray: 2 2,stroke-width:1px
