...
sequenceDiagram
    ...
    deactivate user
    Note over user: default, demo-shell, dev-tools, hyprland<br/>policy:user-to-default
    ...
    Note over p_default: alice/to-hosts, provides/define-user, provides/hostname, provides/mutual-provider
