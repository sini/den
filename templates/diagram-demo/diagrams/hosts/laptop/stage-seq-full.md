# Stage Sequence (expanded): laptop
...
sequenceDiagram
    ...
    Note over host: ── host
    Note over host: default, desktop, hm-host, networking<br/>policy:host-to-default, policy:host-to-hjem-host, policy:host-to-hm-host, policy:host-to-maid-host<br/>policy:host-to-users, policy:host-to-wsl-host, regreet, tailscale<br/>user, virtualization, virtualization/podman, workstation
    ...
    deactivate user
    Note over user: demo-shell, dev-tools, hyprland, policy:user-to-default
