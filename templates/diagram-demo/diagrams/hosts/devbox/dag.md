...
graph LR
  ...
  devbox --> server
  devbox --> workstation
  hm_host --> den__provides__primary_user
  ...
  default__resolve_devbox_{{"default/resolve(devbox)"}}:::default__resolve_devbox__c
  ...
  hm_host__resolve_alice_devbox_["hm-host/resolve(alice,devbox)"]:::hm_host__resolve_alice_devbox__c
  hm_host__resolve_devbox_["hm-host/resolve(devbox)"]:::hm_host__resolve_devbox__c
  ...
  user__resolve_alice_devbox_["user/resolve(alice,devbox)"]:::user__resolve_alice_devbox__c
  user__resolve_bob_devbox_["user/resolve(bob,devbox)"]:::user__resolve_bob_devbox__c
  ...
  n_default --> default__resolve_devbox_
  ...
  hm_host --> hm_host__resolve_alice_devbox_
  hm_host --> hm_host__resolve_devbox_
  ...
  user --> user__resolve_alice_devbox_
  user --> user__resolve_bob_devbox_
  ...
  classDef default__resolve_devbox__c fill:#313244,stroke:#6c7086,color:#cdd6f4,stroke-dasharray: 2 2,stroke-width:1px
  ...
  classDef hm_host__resolve_alice_devbox__c fill:#313244,stroke:#6c7086,color:#cdd6f4,stroke-dasharray: 2 2,stroke-width:1px
  classDef hm_host__resolve_devbox__c fill:#313244,stroke:#6c7086,color:#cdd6f4,stroke-dasharray: 2 2,stroke-width:1px
  ...
  classDef user__resolve_alice_devbox__c fill:#313244,stroke:#6c7086,color:#cdd6f4,stroke-dasharray: 2 2,stroke-width:1px
  classDef user__resolve_bob_devbox__c fill:#313244,stroke:#6c7086,color:#cdd6f4,stroke-dasharray: 2 2,stroke-width:1px
