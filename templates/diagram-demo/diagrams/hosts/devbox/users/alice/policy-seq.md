...
sequenceDiagram
    ...
    Note over user_to_default: default/resolve(alice,devbox)(host), default/resolve(default), provides/default/resolve(define-user):den/provides(host, user), provides/default/resolve(hostname):den/provides(host)<br/>provides/default/resolve(mutual-provider):den/provides(host, user), provides/define-user, provides/hostname, provides/mutual-provider<br/>alice/to-hosts
