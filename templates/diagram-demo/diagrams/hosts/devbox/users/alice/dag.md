...
graph LR
  ...
  default__resolve_alice_devbox_{{"default/resolve(alice,devbox)"}}:::default__resolve_alice_devbox__c
  ...
  den__provides__mutual_provider --> default__resolve_alice_devbox_
  ...
  n_default --> default__resolve_alice_devbox_
  ...
  classDef default__resolve_alice_devbox__c fill:#313244,stroke:#6c7086,color:#cdd6f4,stroke-dasharray: 2 2,stroke-width:1px
