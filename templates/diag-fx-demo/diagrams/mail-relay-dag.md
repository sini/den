...
![Mermaid render](./mail-relay-dag.mmd.svg)
...
graph LR
  ...
  host__self_provide_host_ --> mail
  host__self_provide_host_ --> relay
  mail --> host__self_provide_host_
  mail --> relay
...
![DOT render](./mail-relay-dag.dot.svg)
...
digraph {
  ...
  mail_relay [label="mail-relay",shape=box,style="rounded,filled",fillcolor="#89b4fa",color="#89b4fa",fontcolor="#1e1e2e"];
  ...
  relay [label="relay",shape=box,style=filled,fillcolor="#89b4fa",color="#89b4fa",fontcolor="#1e1e2e"];
...
![PlantUML render](./mail-relay-dag.puml.svg)
...
rectangle "mail-relay" as mail_relay #89b4fa
package "host" as stage_host {
  ...
  rectangle "relay" as relay #89b4fa
