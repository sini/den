# Full DAG: multi-desktop-bob

## Mermaid

![Mermaid render](./multi-desktop-bob-dag.mmd.svg)
...
![DOT render](./multi-desktop-bob-dag.dot.svg)
...
digraph {
  ...
  bob [label="bob",shape=box,style="rounded,filled",fillcolor="#89b4fa",color="#89b4fa",fontcolor="#1e1e2e"];
...
![PlantUML render](./multi-desktop-bob-dag.puml.svg)
