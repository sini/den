...
![Provider matrix](./fleet-provider-matrix.mmd.svg)
...
graph LR
  ...
  subgraph hostsCluster["Hosts"]
    h_angle_brackets(["angle-brackets"]):::matrixhost_c
    h_desktop_gdm(["desktop-gdm"]):::matrixhost_c
    h_devbox(["devbox"]):::matrixhost_c
    h_laptop(["laptop"]):::matrixhost_c
    h_mail_relay(["mail-relay"]):::matrixhost_c
    h_multi_desktop(["multi-desktop"]):::matrixhost_c
    h_provider_filter(["provider-filter"]):::matrixhost_c
    h_web_server(["web-server"]):::matrixhost_c
  end

  p_den --> h_angle_brackets
  p_alice --> h_angle_brackets
  p_virtualization --> h_desktop_gdm
  p_den --> h_desktop_gdm
  p_alice --> h_desktop_gdm
  ...
  p_den --> h_laptop
  p_alice --> h_laptop
  p_monitoring --> h_mail_relay
  p_virtualization --> h_mail_relay
  p_den --> h_mail_relay
  p_virtualization --> h_multi_desktop
  p_den --> h_multi_desktop
  p_alice --> h_multi_desktop
  p_monitoring --> h_provider_filter
  p_virtualization --> h_provider_filter
  p_den --> h_provider_filter
  p_monitoring --> h_web_server
  p_virtualization --> h_web_server
  p_den --> h_web_server
