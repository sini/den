# C4 Container (Mermaid): provider-filter

![C4 Container Mermaid](./provider-filter-c4container-mmd.mmd.svg)
...
C4Container
title Container view: provider-filter

System_Boundary(provider_filter, "provider-filter") {
  Container(ctx_host, "host", "nixos", "14 aspects")
  Container(ctx_default, "default", "homeManager+nixos", "9 aspects")
  Container(ctx_hm_host, "hm-host", "nixos", "4 aspects")
  Container(ctx_hm_user, "hm-user", "nixos", "4 aspects")
  Container(ctx_user, "user", "homeManager+nixos+nixos", "5 aspects")
}
