...
sequenceDiagram
    ...
    Note over host: ── host
    Note over host: backup, desktop, host, monitoring, monitoring/alerting, monitoring/nginx-exporter, monitoring/node-exporter, networking, regreet, server, tailscale, virtualization, virtualization/docker, virtualization/podman, workstation
