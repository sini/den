# Fan-In / Fan-Out: provider-filter

![Fan metrics](./provider-filter-fan.mmd.svg)
...
"networking","reused",1
"tailscale","reused",1
"provider-filter","reused",1
"monitoring/alerting","reused",1
"monitoring/nginx-exporter","reused",1
"monitoring/node-exporter","reused",1
"orchestrates","server",10
"orchestrates","backup",1
"orchestrates","monitoring",2
"orchestrates","virtualization",3
"orchestrates","virtualization/docker",3
"orchestrates","provides/define-user",2
"orchestrates","provides/hostname",2
"orchestrates","provides/mutual-provider",2
"orchestrates","networking",3
"orchestrates","tailscale",3
"orchestrates","provider-filter",2
"orchestrates","monitoring/alerting",1
"orchestrates","monitoring/nginx-exporter",1
"orchestrates","monitoring/node-exporter",1
```
