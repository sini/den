# Full DAG: multi-desktop

## Mermaid

![Mermaid render](./multi-desktop-dag.mmd.svg)
...
graph LR
  ...
  multi_desktop --> host__self_provide_host_
...
![DOT render](./multi-desktop-dag.dot.svg)
...
digraph {
  ...
  multi_desktop [label="multi-desktop",shape=box,style="rounded,filled",fillcolor="#89b4fa",color="#89b4fa",fontcolor="#1e1e2e"];
  ...
  bob [label="bob",shape=box,style=filled,fillcolor="#f38ba8",color="#f38ba8",fontcolor="#1e1e2e"];
  ...
  gnome [label="gnome",shape=box,style=filled,fillcolor="#f2cdcd",color="#f2cdcd",fontcolor="#1e1e2e"];
...
![PlantUML render](./multi-desktop-dag.puml.svg)
