# Resolution Sequence: web-server

![Sequence](./web-server-seq.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: monitoring/alerting, backup, virtualization/docker, host, host/aspect(host), host/cross-provide(<anon>), +9 more
