...
System_Boundary(devbox, "devbox") {
  Container_Boundary(host, "host") {
    ...
    Component(virtualization__docker, "virtualization/docker", "")
...
Rel(server, virtualization__docker, "excluded")
...
Rel(workstation, tailscale, "excluded")
