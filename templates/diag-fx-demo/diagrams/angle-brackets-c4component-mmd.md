# C4 Component (Mermaid): angle-brackets

![C4 Component Mermaid](./angle-brackets-c4component-mmd.mmd.svg)
...
Rel(den__provides__primary_user, networking, "includes")
Rel(desktop, networking, "includes")
Rel(desktop, tailscale, "includes")
Rel(desktop, regreet, "includes")
Rel(dev_tools, alice, "includes")
Rel(dev_tools, demo_shell, "includes")
Rel(dev_tools, hyprland, "includes")
Rel(networking, desktop, "includes")
Rel(regreet, desktop, "includes")
Rel(tailscale, desktop, "includes")
Rel(regreet, networking, "includes")
Rel(tailscale, networking, "includes")
Rel(networking, tailscale, "includes")
Rel(regreet, tailscale, "includes")
...
Rel(primary_user, networking, "includes")
```
