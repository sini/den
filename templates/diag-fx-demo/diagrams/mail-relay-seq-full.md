...
sequenceDiagram
    ...
    Note over host: ── host
    Note over host: backup, host, mail, monitoring, monitoring/alerting, monitoring/nginx-exporter, monitoring/node-exporter, networking, relay, server, tailscale, virtualization, virtualization/docker
