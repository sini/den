# Sankey Flow: multi-desktop

![Sankey](./multi-desktop-sankey.mmd.svg)
...
"alice","dev-tools",1
"alice","hyprland",1
"alice","primary-user",1
"alice","provides/primary-user",1
"bob","dev-tools",1
"bob","gnome",1
"bob","primary-user",1
"bob","provides/primary-user",1
"provides/mutual-provider","alice",5
"desktop","regreet",1
"multi-desktop","workstation",4
"workstation","desktop",1
"workstation","networking",1
"workstation","virtualization",1
"workstation","tailscale",1
```
