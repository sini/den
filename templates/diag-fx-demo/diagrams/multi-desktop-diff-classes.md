# Class Diff (nixos vs homeManager): multi-desktop

![Class diff](./multi-desktop-diff-classes.mmd.svg)
...
graph LR
  ...
  classDef multi_desktop_c fill:#f2cdcd,stroke:#f38ba8,color:#1e1e2e,stroke-dasharray: 5 5,stroke-width:3px
