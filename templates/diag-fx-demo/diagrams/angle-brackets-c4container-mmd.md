# C4 Container (Mermaid): angle-brackets

![C4 Container Mermaid](./angle-brackets-c4container-mmd.mmd.svg)
...
System_Boundary(angle_brackets, "angle-brackets") {
  Container(ctx_host, "host", "nixos", "10 aspects")
  ...
  Container(ctx_user, "user", "homeManager+nixos+homeManager+nixos", "8 aspects")
}
