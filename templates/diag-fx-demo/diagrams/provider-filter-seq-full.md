...
sequenceDiagram
    ...
    Note over host: ── host
    Note over host: backup, host, monitoring, monitoring/alerting, monitoring/nginx-exporter, monitoring/node-exporter, networking, server, tailscale, virtualization, virtualization/docker
