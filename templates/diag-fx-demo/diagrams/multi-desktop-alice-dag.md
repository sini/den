# Full DAG: multi-desktop-alice

## Mermaid

![Mermaid render](./multi-desktop-alice-dag.mmd.svg)
...
![DOT render](./multi-desktop-alice-dag.dot.svg)
...
![PlantUML render](./multi-desktop-alice-dag.puml.svg)
