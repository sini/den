# Orphans and Leaves: angle-brackets-alice

![Orphans and leaves](./angle-brackets-alice-orphans.mmd.svg)
...
graph LR
  ...
  demo_shell["demo-shell · user"]:::demo_shell_c
  dev_tools["dev-tools · user"]:::dev_tools_c
  den__provides__hostname[/"provides/hostname · default"\]:::den__provides__hostname_c
  hyprland["hyprland · user"]:::hyprland_c
  den__provides__mutual_provider[/"provides/mutual-provider · default"\]:::den__provides__mutual_provider_c
  primary_user["primary-user · user"]:::primary_user_c
  den__provides__primary_user[/"provides/primary-user · user"\]:::den__provides__primary_user_c
  ...
  classDef demo_shell_c fill:#f2cdcd,stroke:#f2cdcd,color:#1e1e2e,stroke-width:2px
