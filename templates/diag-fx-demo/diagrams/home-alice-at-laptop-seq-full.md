...
sequenceDiagram
    ...
    Note over home: ── home
    Note over home: alice-dotfiles, demo-shell, dev-tools, home, home-bat, home-dev, home-firefox, home-git, home-productivity, home-slack, hyprland, primary-user, provides/primary-user
