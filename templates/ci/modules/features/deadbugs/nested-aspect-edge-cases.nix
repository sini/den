# Edge cases for nested aspect merging and namespace content wrapper handling.
{
  denTest,
  inputs,
  lib,
...
{
  flake.tests.deadbugs.nested-aspect-edge-cases = {
    ...
    # should still auto-walk those nested keys.
    ...
    # Finding 2b: namespace provider with parametric fn.
