# Resolution Sequence: angle-brackets

![Sequence](./angle-brackets-seq.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: angle-brackets, desktop, host/aspect(host), host/cross-provide(<anon>), host/self-provide(host), networking, +4 more
    ...
    Note over user: alice, demo-shell, dev-tools, hyprland, user, user/aspect(user), +2 more
```
