# Class Diff (nixos vs homeManager): mail-relay

![Class diff](./mail-relay-diff-classes.mmd.svg)
...
graph LR
  ...
  classDef relay_c fill:#89b4fa,stroke:#f38ba8,color:#1e1e2e,stroke-dasharray: 5 5,stroke-width:3px
