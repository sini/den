# Resolution Sequence (expanded): provider-filter

![Sequence expanded](./provider-filter-seq-full.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: backup, monitoring, monitoring/alerting, monitoring/nginx-exporter, monitoring/node-exporter, networking, server, tailscale, virtualization, virtualization/docker
