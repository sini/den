# Resolution Sequence: mail-relay

![Sequence](./mail-relay-seq.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: monitoring/alerting, backup, virtualization/docker, host/aspect(host), host/cross-provide(<anon>), host/self-provide(host), +10 more
