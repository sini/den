# Resolution Sequence: multi-desktop-bob

![Sequence](./multi-desktop-bob-seq.mmd.svg)
...
sequenceDiagram
    ...
    Note over user: bob, dev-tools, gnome, primary-user, provides/primary-user, user/aspect(user), +2 more
