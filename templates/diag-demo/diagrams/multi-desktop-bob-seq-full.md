# Resolution Sequence (expanded): multi-desktop-bob

![Sequence expanded](./multi-desktop-bob-seq-full.mmd.svg)
...
sequenceDiagram
    ...
    Note over user: dev-tools, gnome, primary-user, provides/primary-user

    user ->> p_default: resolve

    Note over p_default: ── default { host, user }
