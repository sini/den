# Simplified View: mail-relay

![Simplified](./mail-relay-simple.mmd.svg)
...
graph LR
  ...
  classDef mail_c fill:#a6e3a1,stroke:#a6e3a1,color:#1e1e2e,stroke-width:3px
  ...
  classDef relay_c fill:#fab387,stroke:#fab387,color:#1e1e2e,stroke-width:3px
