# Resolution Sequence (expanded): multi-desktop

![Sequence expanded](./multi-desktop-seq-full.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: desktop, networking, regreet, tailscale, virtualization, virtualization/podman, workstation
    ...
    Note over user: alice, bob, demo-shell, dev-tools, gnome, hyprland, primary-user, provides/primary-user, user
