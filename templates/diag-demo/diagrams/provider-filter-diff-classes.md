# Class Diff (nixos vs homeManager): provider-filter

![Class diff](./provider-filter-diff-classes.mmd.svg)
...
graph LR
  ...
  classDef provider_filter_c fill:#89b4fa,stroke:#f38ba8,color:#1e1e2e,stroke-dasharray: 5 5,stroke-width:3px
