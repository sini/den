# Resolution Sequence (expanded): desktop-gdm

![Sequence expanded](./desktop-gdm-seq-full.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: desktop, gdm, networking, regreet, tailscale, virtualization, virtualization/podman, workstation
