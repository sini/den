# C4 Container (Mermaid): multi-desktop

![C4 Container Mermaid](./multi-desktop-c4container-mmd.mmd.svg)
...
C4Container
title Container view: multi-desktop

System_Boundary(multi_desktop, "multi-desktop") {
  Container(ctx_host, "host { host }", "nixos", "10 aspects")
  ...
  Container(ctx_user, "user { host, user }", "homeManager+nixos+homeManager+nixos", "12 aspects")
}
