# Resolution Sequence: laptop

![Sequence](./laptop-seq.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: desktop, host/aspect(host), host/cross-provide(<anon>), host/self-provide(host), laptop, networking, +5 more
