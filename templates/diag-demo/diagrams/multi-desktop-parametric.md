# Parametric Aspects: multi-desktop

![Parametric](./multi-desktop-parametric.mmd.svg)
...
graph LR
  ...
  alice{{"alice({ aspect-chain, class }) · user"}}:::alice_c
  ...
  alice__to_hosts[/"alice/to-hosts · default"\]:::alice__to_hosts_c
