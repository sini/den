...
graph LR
  ...
  ctx_host["host { host } · context"]:::ctx_host_c
  ctx_default["default { host } · context"]:::ctx_default_c
  ctx_hm_host["hm-host { host } · context"]:::ctx_hm_host_c
  ctx_hm_user["hm-user { host, user } · context"]:::ctx_hm_user_c
  ctx_user["user { host, user } · context"]:::ctx_user_c
  ...
  classDef ctx_host_c fill:#fab387,stroke:#fab387,color:#1e1e2e,stroke-width:2px
  classDef ctx_default_c fill:#f38ba8,stroke:#f38ba8,color:#1e1e2e,stroke-width:2px
  classDef ctx_hm_host_c fill:#f38ba8,stroke:#f38ba8,color:#1e1e2e,stroke-width:2px
  classDef ctx_hm_user_c fill:#fab387,stroke:#fab387,color:#1e1e2e,stroke-width:2px
  classDef ctx_user_c fill:#f9e2af,stroke:#f9e2af,color:#1e1e2e,stroke-width:2px
```
