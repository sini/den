...
![Mermaid render](./web-server-dag.mmd.svg)
...
![DOT render](./web-server-dag.dot.svg)
...
digraph {
  ...
  web_server [label="web-server",shape=box,style="rounded,filled",fillcolor="#89b4fa",color="#89b4fa",fontcolor="#1e1e2e"];
...
![PlantUML render](./web-server-dag.puml.svg)
...
rectangle "web-server" as web_server #89b4fa
