# Full DAG: angle-brackets

## Mermaid

![Mermaid render](./angle-brackets-dag.mmd.svg)
...
![DOT render](./angle-brackets-dag.dot.svg)
...
digraph {
  ...
  angle_brackets [label="angle-brackets",shape=box,style="rounded,filled",fillcolor="#89b4fa",color="#89b4fa",fontcolor="#1e1e2e"];
...
![PlantUML render](./angle-brackets-dag.puml.svg)
...
rectangle "angle-brackets" as angle_brackets #89b4fa
package "host { host }" {
