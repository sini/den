# Resolution Sequence: desktop-gdm

![Sequence](./desktop-gdm-seq.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: desktop, desktop-gdm, gdm, host/aspect(host), host/cross-provide(<anon>), host/self-provide(host), +6 more
