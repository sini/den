# Resolution Sequence: multi-desktop

![Sequence](./multi-desktop-seq.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: desktop, host/aspect(host), host/cross-provide(<anon>), host/self-provide(host), multi-desktop, networking, +5 more
    ...
    Note over user: alice, bob, demo-shell, dev-tools, gnome, hyprland, +6 more
```
