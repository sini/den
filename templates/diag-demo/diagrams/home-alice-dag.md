...
![Mermaid render](./home-alice-dag.mmd.svg)
...
graph LR
  ...
  subgraph ctx_default["default { home }"]
  ...
  classDef alice_c fill:#cba6f7,stroke:#cba6f7,color:#1e1e2e,stroke-dasharray: 3 3,stroke-width:1px
...
![DOT render](./home-alice-dag.dot.svg)
...
digraph {
  ...
  home [label="home",shape=box,style=filled,fillcolor="#a6e3a1",color="#a6e3a1",fontcolor="#1e1e2e"];
...
![PlantUML render](./home-alice-dag.puml.svg)
