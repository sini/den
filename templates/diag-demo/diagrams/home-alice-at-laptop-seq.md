# Resolution Sequence: home-alice-at-laptop

![Sequence](./home-alice-at-laptop-seq.mmd.svg)
...
sequenceDiagram
    ...
    Note over home: alice, alice-dotfiles, demo-shell, dev-tools, home-bat, home-dev, +10 more
    Note over p_default: default, default/aspect(default), provides/default/aspect(default):den/provides, default/cross-provide(home), default/self-provide(default), provides/define-user, +2 more
```
