# Simplified View: desktop-gdm

![Simplified](./desktop-gdm-simple.mmd.svg)
...
graph LR
  ...
  classDef gdm_c fill:#a6e3a1,stroke:#a6e3a1,color:#1e1e2e,stroke-width:3px
  ...
  classDef workstation_c fill:#a6e3a1,stroke:#a6e3a1,color:#1e1e2e,stroke-width:3px
```
