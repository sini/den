...
![Treemap](./devbox-treemap.mmd.svg)
...
"alice"
    "alice/to-hosts": 1
"den"
    "provides/default/aspect(default):den/provides": 1
    "provides/define-user": 1
    "provides/hostname": 1
    "provides/mutual-provider": 1
    "provides/primary-user": 1
"monitoring"
    "monitoring/alerting": 1
    "monitoring/nginx-exporter": 1
    "monitoring/node-exporter": 1
"virtualization"
    "virtualization/docker": 1
    "virtualization/podman": 1
```
