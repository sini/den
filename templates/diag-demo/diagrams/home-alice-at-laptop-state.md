# Context State Diagram: home-alice-at-laptop

![State](./home-alice-at-laptop-state.mmd.svg)
...
stateDiagram-v2
    s_home___home__ : home { home }
    s_default___home__ : default { home }

    alice --> s_home___home__
    s_home___home__ --> s_default___home__
```
