# Resolution Sequence (expanded): angle-brackets

![Sequence expanded](./angle-brackets-seq-full.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: desktop, networking, primary-user, provides/primary-user, regreet, tailscale
    ...
    Note over user: alice, demo-shell, dev-tools, hyprland, user
