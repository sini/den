# Context State Diagram: provider-filter

![State](./provider-filter-state.mmd.svg)
...
stateDiagram-v2
    s_host___host__ : host { host }
    s_default___host__ : default { host }
    s_hm_host___host__ : hm-host { host }
    s_hm_user___host__user__ : hm-user { host, user }
    s_user___host__user__ : user { host, user }

    provider_filter --> s_host___host__
    s_host___host__ --> s_default___host__
    s_host___host__ --> s_hm_host___host__
    s_hm_host___host__ --> s_hm_user___host__user__
    s_host___host__ --> s_user___host__user__
    s_user___host__user__ --> s_default___host__
```
