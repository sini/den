# Context State Diagram: provider-filter-deploy

![State](./provider-filter-deploy-state.mmd.svg)
...
stateDiagram-v2
    ...
    s_default___host__user__ : default { host, user }

    deploy --> s_user___host__user__
    s_user___host__user__ --> s_default___host__user__
```
