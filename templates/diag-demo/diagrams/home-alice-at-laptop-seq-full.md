# Resolution Sequence (expanded): home-alice-at-laptop

![Sequence expanded](./home-alice-at-laptop-seq-full.mmd.svg)
...
sequenceDiagram
    participant home as home { home }
    participant p_default as default { home }

    Note over home: ── home { home }
    Note over home: alice-dotfiles, demo-shell, dev-tools, home-bat, home-dev, home-firefox, home-git, home-productivity, home-slack, hyprland, primary-user, provides/primary-user

    home ->> p_default: resolve

    Note over p_default: ── default { home }
    Note over p_default: default, provides/define-user, provides/hostname, provides/mutual-provider
```
