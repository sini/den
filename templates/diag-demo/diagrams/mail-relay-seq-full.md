# Resolution Sequence (expanded): mail-relay

![Sequence expanded](./mail-relay-seq-full.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: backup, mail, monitoring, monitoring/alerting, monitoring/nginx-exporter, monitoring/node-exporter, networking, relay, server, tailscale, virtualization, virtualization/docker
