# Resolution Sequence (expanded): angle-brackets-alice

![Sequence expanded](./angle-brackets-alice-seq-full.mmd.svg)
...
sequenceDiagram
    ...
    Note over user: demo-shell, dev-tools, hyprland, primary-user, provides/primary-user
