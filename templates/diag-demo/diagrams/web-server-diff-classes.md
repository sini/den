# Class Diff (nixos vs homeManager): web-server

![Class diff](./web-server-diff-classes.mmd.svg)
...
graph LR
  ...
  classDef web_server_c fill:#cba6f7,stroke:#f38ba8,color:#1e1e2e,stroke-dasharray: 5 5,stroke-width:3px
