# Resolution Sequence: devbox

![Sequence](./devbox-seq.mmd.svg)
...
sequenceDiagram
    ...
    Note over host: monitoring/alerting, backup, desktop, devbox, virtualization/docker, host/aspect(host), +12 more
