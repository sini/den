...
![Mermaid render](./laptop-dag.mmd.svg)
...
graph LR
  ...
  desktop --> regreet
  laptop --> host__self_provide_host_
  laptop --> workstation
...
digraph {
  ...
  laptop [label="laptop",shape=box,style="rounded,filled",fillcolor="#89b4fa",color="#89b4fa",fontcolor="#1e1e2e"];
...
![PlantUML render](./laptop-dag.puml.svg)
...
rectangle "laptop" as laptop #89b4fa
package "host { host }" {
