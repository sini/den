# Context Hierarchy: home-alice-at-laptop

![Context hierarchy](./home-alice-at-laptop-ctx.mmd.svg)
...
graph LR
  alice([alice]):::root
  ctx_home["home { home } · context"]:::ctx_home_c
  ctx_default["default { home } · context"]:::ctx_default_c

  alice --> ctx_home
  ctx_home --> ctx_default

  classDef root fill:#89b4fa,stroke:#89b4fa,color:#1e1e2e,font-weight:bold
  classDef ctx_home_c fill:#f38ba8,stroke:#f38ba8,color:#1e1e2e,stroke-width:2px
